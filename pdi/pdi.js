...
var p_2022_07 = ((precipitation.filter(ee.Filter.date('2022-07-01','2022-07-26'))).reduce(ee.Reducer.sum())).clip(som);


var p_2022_08 = (august_2022.select(['b1']).rename(['precipitation_sum'])).clip(som);
...
var p_mod_2022_07_runlgth_average = (ee.ImageCollection([p_mod_2022_07,p_mod_2022_06,p_mod_2022_05,p_mod_2022_04,p_mod_2022_03,p_mod_2022_02])).mean();
...
var runlength_2001_june = (ee.ImageCollection([deficit_2001_june,deficit_2001_may,deficit_2001_april,deficit_2001_march,deficit_2001_february,deficit_2001_january]));/*.mean()*/
...
//final runlength calculation. This is for february. Change this to the month you are interested in
...
//modified runlength (modified RL =(Rlmax+1)-RL). This is for february. Change this to the month you are interested in
...
//mean values for the modified runlenths, per month. This is for february. Change this to the month you are interested in
...
//calculating PDI. This is for february. Change this to the month you are interested in



var PDI_august_2022 = (p_mod_2022_08_runlgth_average.divide(p_mod_august_runlgth_mean)).multiply(((modified_runlength_august_2022).divide(mean_modified_RL_august)).sqrt())
...
'2) = precipitation.filter<=0.4 9999 9999 1 *',
'3) = ((precipitation.filter>0.4 9999 9999 9999',
'6) = ((precipitation.filter<=0.6 9999 9999 2 *',
'7) = ((precipitation.filter>0.6 9999 9999 9999',
'14) = ((precipitation.filter<=0.8 9999 9999 3 *',
'15) = ((precipitation.filter>0.8 9999 9999 9999',
'30) = ((precipitation.filter<=1 9999 9999 4 *',
'31) = ((precipitation.filter>1 9999 9999 5 *'].join("\n");*/
...
'31) precipitation_sum>1 9999 9999 5 *'].join("\n");



var pdi_classifier = ee.Classifier.decisionTree(pd_reclass);

var pdi_2022_august_reclass = (PDI_august_2022).select('precipitation_sum').classify(pdi_classifier);
...
//Map.addLayer(PDI_august_2022.clip(som), {min:0, max:6}, "PDI_feb_2022")
...
Map.centerObject(som, 12)
Map.addLayer(som, {}, 'som')
Map.addLayer(pdi_2022_august_reclass.clip(som), cdiVis, "PDI_august_2022")

//Exporting to drive

Export.image.toDrive({
  image:pdi_2022_august_reclass.clip(som),
  description:'pdi_2022_august_reclass_som_ver22',
  scale:5566,
  folder:'cdi',
  maxPixels:1e13,
  region:som
...
Export.image.toDrive({
  image:PDI_august_2022.clip(som),
  description:'PDI_august_2022_RAW_ver22',
  scale:5566,
  folder:'cdi',
  maxPixels:1e13,
  region:som
...
/*Export.image.toDrive({
  image:p_2018_12.clip(one),
  description:'p_2018_12',
  scale:5566,
  folder:'cdi',
  maxPixels:1e13,
  region:one
...
//Scripts from the following links were used as a guide to write the function for the runlength
